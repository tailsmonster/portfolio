    ...
    <>
      <section id="top" className="max-w-6xl mx-auto pt-10">
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div id="right">
            <div>
              <img className="m-5 p-3 w-80 h-80 rounded-[50px] -rotate-6"src="https://drive.google.com/file/d/1yk2oAyflO5ybdqnJAEZWuGbv8hIAi0kY/view?usp=drive_link" alt="My Linkedin Portrait" />
            </div>
          </div>
        </div>
        <div id="landingpage-buttons" className="flex justify-around">
          <div>
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contact Me</button>      
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Projects</button>      
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Experience</button>      
